...
class AdapterCompletedTaskSearch(var myTasks : ArrayList<CompletedTask> ,var eventListenerCompletedTask: EventListenerCompletedTask) :  RecyclerView.Adapter<AdapterCompletedTaskSearch.Vh>() {

    lateinit var myParent: ViewGroup


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterCompletedTaskSearch.Vh {
        myParent = parent
        return Vh(LayoutInflater.from(parent.context).inflate(R.layout.row_completed, parent, false))
    }

    override fun onBindViewHolder(holder: AdapterCompletedTaskSearch.Vh, position: Int) {
    ...
    inner class Vh(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private var cardView: MaterialCardView = itemView.findViewById(R.id.cardViewItem)
        ...
        fun bind(task: CompletedTask) {
            ...
            itemView.setOnClickListener {
                eventListenerCompletedTask.onclick(myTasks[adapterPosition], adapterPosition)
    ...
    interface EventListenerCompletedTask {
        ...
        fun onclick(task: CompletedTask, position: Int)
        fun onReturnResultList(newList: List<CompletedTask>, position: Int)
    }
